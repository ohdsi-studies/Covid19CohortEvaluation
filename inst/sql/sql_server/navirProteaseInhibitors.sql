...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1789428,1727223,1756831,1736829,1711523,1715472,1748921,1746244,1736999)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1789428,1727223,1756831,1736829,1711523,1715472,1748921,1746244,1736999)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4013106,4078242,44783356,439727)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4013106,4078242,44783356,439727)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (432554)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (432554)
  and c.invalid_reason is null
...
JOIN #Codesets codesets on ((de.drug_concept_id = codesets.concept_id and codesets.codeset_id = 23))
) C
...
FROM (
	...
	JOIN #Codesets cs on cs.codeset_id = 23 AND de.drug_concept_id = cs.concept_id
	...
	FROM @cdm_database_schema.DRUG_EXPOSURE de
	JOIN ctePersons p on de.person_id = p.person_id
	JOIN #Codesets cs on cs.codeset_id = 23 AND de.drug_source_concept_id = cs.concept_id
) E
;
